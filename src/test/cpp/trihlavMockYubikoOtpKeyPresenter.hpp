 ...
 */
#ifndef TRIHLAV_MOCK_YUBIKO_OTP_KEY_PRESENTER_HPP_
#define TRIHLAV_MOCK_YUBIKO_OTP_KEY_PRESENTER_HPP_
...
struct MockYubikoOtpKeyPresenter: virtual public IYubikoOtpKeyPresenter {
	...
	virtual ~MockYubikoOtpKeyPresenter();
};
}
/* namespace trihlav */

#endif /* TRIHLAV_MOCK_YUBIKO_OTP_KEY_PRESENTER_HPP_ */
